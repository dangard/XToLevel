...
function XToLevel.Lib:ZoneID()
	...
	local AceLibTourist = LibStub:GetLibrary("LibTourist-3.0");
	...
	local continentNames, key, val = { AceLibTourist:GetMapContinentsAlt() } ;
	for key, val in pairs(continentNames) do
		local continentZones = { AceLibTourist:GetMapZonesAlt(key) };
